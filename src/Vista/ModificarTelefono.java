...
public class ModificarTelefono extends javax.swing.JFrame {
    ...
    private void initComponents() {
        ...
        jLabel1.setText("Modificación de Teléfonos");

        jPanel4.setBackground(new java.awt.Color(65, 58, 132));

        opcionesVisualizaciones.setModel(new javax.swing.DefaultComboBoxModel<>(new String[] { "Número telefónico", "ID de teléfono" }));
        ...
        modificarT.setBackground(new java.awt.Color(65, 58, 132));
        modificarT.setFont(new java.awt.Font("Microsoft YaHei", 1, 12)); // NOI18N
        modificarT.setForeground(new java.awt.Color(255, 255, 255));
        modificarT.setText("Modificar este teléfono");
    ...
    private void modificarTActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_modificarTActionPerformed
        ...
        if(opc!=-1){
            String idC = usuarios.getValueAt(opc,1).toString();
            long idT = Long.parseLong(usuarios.getValueAt(opc,2).toString());
            String tel = usuarios.getValueAt(opc,3).toString();
            String com = usuarios.getValueAt(opc,4).toString();
            String pre = usuarios.getValueAt(opc,5).toString();
            String pais = usuarios.getValueAt(opc,6).toString();
            String tipo = usuarios.getValueAt(opc,7).toString();
