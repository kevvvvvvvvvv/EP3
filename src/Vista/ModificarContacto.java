...
public class ModificarContacto extends javax.swing.JFrame {
    ...
    private void initComponents() {
        ...
        jLabel1.setText("Modificación de Contactos");
        ...
        modificar.setBackground(new java.awt.Color(65, 58, 132));
        modificar.setFont(new java.awt.Font("Microsoft YaHei", 1, 12)); // NOI18N
        modificar.setForeground(new java.awt.Color(255, 255, 255));
        modificar.setText("Modificar este contacto");
    ...
    private void modificarActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_modificarActionPerformed
        ...
        if(opc!=-1 && usuarios.getValueAt(opc, 0)!=null){
            /*ConfirmarEliminacionCon cec = new ConfirmarEliminacionCon();
            cec.setVisible(true);*/
            int id = Integer.parseInt(usuarios.getValueAt(opc, 0).toString());
            String nom = usuarios.getValueAt(opc, 1).toString();
            String ap = usuarios.getValueAt(opc, 2).toString();
            String am = usuarios.getValueAt(opc, 3).toString();
            String ed = usuarios.getValueAt(opc, 4).toString();
            String es = usuarios.getValueAt(opc, 6).toString();
            String p = usuarios.getValueAt(opc, 7).toString();
            try { 
                LogicaContacto lc = new LogicaContacto();
                lc.validarContacto(id ,nom, ap, am, p, es, ed);
